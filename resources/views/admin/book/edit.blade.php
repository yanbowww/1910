...
<form action="{{url('/book/update/'.$booklist->book_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
  @csrf
  <!-- {{csrf_field()}}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$booklist->book_name}}" name="book_name" id="firstname" 
           placeholder="请输入文章标题">
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$booklist->book_man}}" name="book_man" id="firstname" 
           placeholder="请输入文章作者">
    </div>
    <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">作者email</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$booklist->book_email}}" name="book_email" id="firstname" 
           placeholder="请输入作者email">
    </div>
    <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">关键字</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$booklist->book_zi}}" name="book_zi" id="firstname" 
           placeholder="请输入关键字">
    </div>
    <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">网页描述</label>
    <div class="col-sm-10">
      <textarea class="form-control" value="{{$booklist->book_intro}}" name="book_intro" id="firstname">
      </textarea>
    </div>
     <div class="form-group">
