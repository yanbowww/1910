...
<form action="{{url('/lianjie/update/'.$lianjie->l_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
  @csrf
  <!-- {{csrf_field()}}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$lianjie->l_name}}" name="l_name" id="firstname" 
           placeholder="请输入网站名称">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$lianjie->l_wangzhi}}" name="l_wangzhi" id="firstname" 
           placeholder="请输入网站网址">
    ...
    <div class="col-sm-10">
      ...
      @if($lianjie->l_logo)<img src="{{env('UPLOADS_URL')}}{{$lianjie->l_logo}}" width="300" height="180">@endif
    </div>

     <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">网站联系人</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$lianjie->l_man}}" name="l_man" id="firstname" 
